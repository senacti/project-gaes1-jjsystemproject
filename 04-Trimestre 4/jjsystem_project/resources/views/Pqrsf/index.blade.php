                    ...
                    <section class="s-data-table">
                        <table class="table data-table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $pqrsf->EstadoPQRSF_idEstadoPQRSF}}</td> 
                                <td><a href="{{ url('pqrsf/'.$pqrsf->idPQRSF. '/edit') }}" class="btn btn-primary btn-sw">Editar</a></td>
                                <td>
                        ...
                        <a href="{{ url('pqrsf/create') }}" class="btn btn-primary btn-sm">Añadir Pqrsf</a>
