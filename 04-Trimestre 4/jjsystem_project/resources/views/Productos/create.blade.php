            ...
            <form action="{{ url('Productos')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="form-content">
                        ...
                        <input type="text" id="nombreProducto" name="nombreProducto" placeholder="Nombre" value="{{old('nombreProducto')}}" required>
                    </div>
                    <div class="form-content">
                        <label for="precioProducto">Precio</label>
                        <input type="number" id="precioProducto" name="precioProducto" placeholder="Precio" value="{{old('precioProducto')}}">
                    </div>
                    <div class="form-content">
                        <label for="cantidad">Cantidad</label>
                        <input type="number" id="cantidad" name="cantidad" placeholder="Cantidad" value="{{old('cantidad')}}" required>
                    </div>
                    <div class="form-content">
                        ...
                        <select name="categoriaProducto" id="categoriaProducto" class="form-select" required>
                            ...
                            <option value="{{$categoriaProducto->id}}">{{$categoriaProducto->nombreCategoria}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-content">
                        ...
                        <select name="proveedorProducto" id="proveedorProducto" class="form-select" required>
                            ...
                            <option value="{{$proveedorProducto->id}}">{{$proveedorProducto->nombreProveedor}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-content">
                        <label for="descripcionProducto">Descripción</label>
                        <textarea name="descripcionProducto" id="descripcionProducto" cols="30" rows="10" placeholder="Descripción" value="{{old('descripcionProducto')}}" required></textarea>
                    </div>
